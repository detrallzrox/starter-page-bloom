-- Verificar triggers existentes usando pg_trigger diretamente
SELECT 
    t.tgname as trigger_name,
    c.relname as table_name
FROM pg_trigger t
JOIN pg_class c ON t.tgrelid = c.oid
WHERE t.tgname LIKE '%investment_balance%'
  AND NOT t.tgisinternal;

-- Remover qualquer trigger duplicado e recriar apenas um
...
-- Recriar função com logs detalhados para debug
