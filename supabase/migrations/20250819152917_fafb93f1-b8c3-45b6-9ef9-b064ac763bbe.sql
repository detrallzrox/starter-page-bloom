-- Ajustar função para criar notificações apenas para o proprietário da conta atual
  ...
  LOOP
    ...
    IF percentage_used >= 100 THEN
      ...
      IF existing_notification_count = 0 THEN
        -- Criar notificação apenas para o proprietário da conta (NEW.user_id)
        ...
        RAISE LOG 'Budget notification created for account owner: % (category: %)', 
          NEW.user_id, budget_record.category_name;
      ELSE
