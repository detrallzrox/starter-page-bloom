...
-- 3. Remove duplicate index from category_budgets table
-- Keep the more descriptive one and drop the generic one
DROP INDEX IF EXISTS public.category_budgets_user_id_category_id_period_start_period_en_key;