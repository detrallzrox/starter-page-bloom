...
-- Schedule check-due-reminders to run every minute
SELECT cron.schedule(
  ...
  SELECT
    net.http_post(
      url := 'https://jwizzrqgchmsstwadtth.supabase.co/functions/v1/check-due-reminders',
...
-- Schedule process-bill-notifications to run daily at 9 AM
SELECT cron.schedule(
