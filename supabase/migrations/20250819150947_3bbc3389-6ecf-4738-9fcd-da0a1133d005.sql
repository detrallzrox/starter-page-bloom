-- Criar função para verificar orçamento excedido após inserir transação
...
-- Criar trigger para executar a função após inserir transação
DROP TRIGGER IF EXISTS budget_check_trigger ON transactions;
